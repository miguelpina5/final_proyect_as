...
int main(int argc, char * argv[])
{
  ...
  factory.registerFromPlugin(loader.getOSName("randomWp_bt_node"));

  std::string pkgpath = ament_index_cpp::get_package_share_directory("final_proyect_as");
  std::string xml_file = pkgpath + "/BTs/juego_sin_hablar.xml";
